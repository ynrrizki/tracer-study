    ...
    <div class="container mx-auto px-4 lg:max-w-7xl flex justify-between">
        <div class="flex flex-row gap-1 items-center py-3 md:py-2">
            <a data-aos="fade-right" href="/" class="flex items-center" aria-label="Go to home">
                <img class="h-14 sm:h-16 transition-all ease-out duration-1000" src="{{ asset('assets/logo/logo.png') }}"
                    alt="Prestasi Prima">
...
<div id="crypto-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        ...
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow-xl duration-300">
            <button type="button"
